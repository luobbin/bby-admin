  ...
  return (
    <Space direction="vertical" size="large" className="w-full">
              ...
              <Form.Item<SearchFormFieldType> label="状态" name="status" className="!mb-0">
                <Select>
                  <Select.Option value="0">
                    <ProTag color="gray">待处理</ProTag>
                  </Select.Option>
                  <Select.Option value="1">
                    <ProTag color="green">处理中</ProTag>
                  </Select.Option>
                  <Select.Option value="2">
                    <ProTag color="success">处理成功</ProTag>
                  </Select.Option>
                  <Select.Option value="3">
                    <ProTag color="error">处理失败</ProTag>
                  </Select.Option>
                </Select>
              </Form.Item>
            </Col>
      ...
      >
        ...
        <SolutionBusinessModal {...modalProps} />
      </Card>
    </Space>
  );
}
