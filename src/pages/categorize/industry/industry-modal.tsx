...
import { ItemReq, SearchReq, useAdd, useList, useUpdate } from "@/api/services/industryService";
...
export function IndustryModal({ title, show, formValue, onOk, onCancel }: ItemModalProps) {
  ...
  const handleFinish = async () => {
    // @ts-ignore
    const item: RegionReq = form.getFieldsValue();
    try {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item<ItemReq> label="父级行业" name="pid">
          <Select
            fieldNames={{
              label: 'name',
              value: 'id',
