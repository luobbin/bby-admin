...
import { RegionModal, ItemModalProps } from './region-modal.tsx';

import { IfShowStatus } from '#/enum';
import { PageList, SearchReq, ItemReq, useList } from '@/api/services/regionService';

const IFSHOW_TAG: Array<string> = ['待定', '显示', '禁用',];
const PAGE_TITLE = '地区 列表';
