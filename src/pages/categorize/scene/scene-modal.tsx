...
import { ItemReq, SearchReq, useAdd, useList, useUpdate } from '@/api/services/sceneService';
...
export function SceneModal({ title, show, formValue, onOk, onCancel }: ItemModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item<ItemReq> label="父级场景" name="pid">
          <Select
            fieldNames={{
              label: 'name',
              value: 'id',
