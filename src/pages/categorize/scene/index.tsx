...
import { SceneModal, ItemModalProps } from './scene-modal.tsx';

import { IfShowStatus } from '#/enum';
import { ItemReq, PageList, SearchReq, useList } from '@/api/services/sceneService.ts';

const IFSHOW_TAG: Array<string> = ['待定', '显示', '禁用',];
const PAGE_TITLE = '场景 列表';
